<div class="achievements mt-[18vw] md:-mt-[2.3vw]" data-aos="flip-up">
    <div class="achievements-wrapper flex justify-center items-center">
        <div class="achievements-list hidden md:flex items-center gap-[5.7vw] bg-white shadow-2xl px-[4vw] py-[2vw] rounded-xl" style="box-shadow: 0px 0px 12.9px 0px rgba(0, 0, 0, 0.15);">
